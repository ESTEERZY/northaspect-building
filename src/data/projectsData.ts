...
export const projectsData: CaseStudyData[] = [
  {
    ...
    overview: 'Merging brutalist form with Beverly Hills hillside topography. Large cast-in-place concrete cantilevers suspend living volumes over the terrain, while seamless floor-to-ceiling glass envelopes frame panoramic views.',
  ...
  },
  {
    ...
    overview: 'A contemporary chalet designed for extreme alpine climates. Heavy glulam columns and a structural stone core anchor the residence, while double-glazed glass curtain walls frame spectacular snow-capped peaks.',
  ...
  },
  {
    ...
    overview: 'Redefining vertical living in Manhattan. High-performance steel framing combined with structural acoustic dampening, featuring complex structural setbacks and a pre-weathered bronze facade.',
  ...
  },
  {
    ...
    overview: 'A minimalist coastal pavilion on a Malibu bluff. Ultra-slender carbon-fiber concrete supports allow a wide-span living area completely free of interior columns, merging seamlessly with the oceanfront pool deck.',
