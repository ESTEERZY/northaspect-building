  ...
  const projects = [
    {
      ...
      scale: '450 sqm',
      status: 'Completed',
      materials: 'Timber Frame & Steel',
      intent: 'Balancing rugged structural permanence with refined coastal living spaces and master carpentry.',
    },
    {
      ...
      scale: '380 sqm',
      status: 'Completed',
      materials: 'Australian Hardwood & Glazing',
      intent: 'Connecting light-filled interior living spaces with custom timber soffits and architectural extensions.',
    },
    {
      ...
      scale: '520 sqm',
      status: 'Completed',
      materials: 'Hardwood Timber & Render',
      intent: 'An elegant contemporary home seamlessly combining custom timber decks, pergolas, and modern family living.',
    }
  ]
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="mt-32 text-center animate-slide-up border-t border-white/10 pt-24" style={{ animationDelay: '0.3s' }}>
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault()
              const element = document.getElementById('book-a-call') || document.getElementById('contact')
