      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white/20 backdrop-blur-md border border-white/50 border-l-[4px] border-l-sand p-10 hover:bg-white/40 shadow-sm hover:shadow-md transition-all duration-300 group rounded-[2px]"
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 bg-sand flex items-center justify-center group-hover:bg-charcoal transition-all duration-300 rounded-[2px]">
                    <service.icon className="w-8 h-8 text-white transition-colors" strokeWidth={2.5} />
                  </div>
                </div>
                <div className="flex-1">
                  <h3 className="text-2xl font-black text-charcoal mb-4">{service.title}</h3>
        ...
        <div className="mt-16 text-center bg-white/20 backdrop-blur-md border border-white/50 p-12 shadow-sm rounded-[2px]">
          <h3 className="text-3xl font-black text-charcoal mb-4">Need a Custom Solution?</h3>
