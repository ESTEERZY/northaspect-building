  ...
  return (
    <section id="services" className="py-24 bg-white relative">
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-charcoal/10 border border-gold/40 px-5 py-3 rounded-[2px]">
            <span className="w-2 h-2 bg-gold"></span>
            <span className="text-xs font-black tracking-[0.2em] text-charcoal/70 uppercase">Our Services</span>
          </div>
          ...
          <p className="text-xl text-charcoal/60 font-medium max-w-2xl mx-auto leading-relaxed">
        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="bg-white border border-gold/15 border-l-[3px] border-l-gold p-8 hover:shadow-[0_8px_30px_rgba(197,160,89,0.12)] transition-all duration-500 group rounded-[2px] flex gap-6 items-start"
            >
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-black tracking-tighter text-charcoal mb-3 group-hover:text-gold transition-colors duration-300">{service.title}</h3>
                <p className="text-base text-charcoal/60 leading-relaxed font-medium">{service.description}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 text-center bg-white border border-gold/20 p-12 shadow-sm rounded-[2px]"
        >
          <h3 className="text-3xl font-black tracking-tighter text-charcoal mb-4">Need a Custom Solution?</h3>
          <p className="text-lg text-charcoal/60 mb-8 font-medium">Let's discuss your unique project requirements and create a tailored approach.</p>
          <a
            href="#contact"
