      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-base text-zinc-900 leading-relaxed font-medium font-sans max-w-lg">
              ...
              {advantages.map((item, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-zinc-950 text-sm tracking-wide uppercase">{item.name}</span>
                    <span className="font-semibold text-zinc-950 text-sm">{item.percentage}%</span>
                  </div>
            ...
            <p className="text-xs text-zinc-800 font-semibold tracking-widest uppercase pt-4">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-zinc-950 text-white p-8 border border-zinc-800 shadow-xl">
              <div className="text-4xl font-semibold tracking-tight">Zero</div>
              <div className="text-xs mt-2 uppercase tracking-widest text-white font-bold">Tolerance Policy</div>
            </div>
          </div>
        </div>
      </div>
