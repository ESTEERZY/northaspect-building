        ...
        <div className="grid md:grid-cols-2 gap-6">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-zinc-600 font-light leading-relaxed text-sm mb-8">"{testimonial.text}"</p>
              <div className="flex items-center gap-4 pt-6 border-t border-zinc-200">
                ...
                <div>
                  ...
                  <div className="text-xs text-zinc-500 uppercase tracking-widest mt-0.5">Verified Client</div>
                </div>
              </div>
            </div>
          ))}
